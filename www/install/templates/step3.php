      ...
      <div class="server">
        <table width="100%">
          ...
          <tr>
            ...
            <td><input type="text" name="dbname" id="dbname" value="vaa" class="input" onBlur="TestDbPwd(0)"></td>
          ...
          <table width="100%">
              <tr>
                  <td class="td1" width="100">版本信息</td>
                  <td class="td1" width="200">&nbsp;</td>
                  <td class="td1">&nbsp;</td>
              </tr>
              <tr>
                  <td class="tar">选择版本：</td>
                  <td>
                      <select name="app_type" id="app_type" value="1" >
                          <option selected value="1">设备版</option>
                          <option value="2">手机版</option>
                          <option value="0">完整版</option>
                      </select>
<!--                      <input type="text" name="manager" id="manager" value="admin" class="input"></td>-->
