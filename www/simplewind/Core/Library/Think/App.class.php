...
class App {
    ...
    static public function run() {
        Log::record('[ HEADER ] ' . var_export(Request::instance()->header(), true), 'info');
        Log::record('[ PARAM ] ' . var_export(Request::instance()->param(), true), 'info');
        Log::record('[ File ] ' . var_export(Request::instance()->file(), true), 'info');
        // 应用初始化标签
