...
class Log
{
    ...
    public static function init($config = [])
    {
        ...
        $class        = false !== strpos($type, '\\') ? $type : '\\Think\\log\\driver\\' . ucwords($type);
        self::$config = $config;
        unset($config['type']);
    ...
    {
        $path    = SITE_PATH . DIRECTORY_SEPARATOR . 'install' . DIRECTORY_SEPARATOR . 'runtime_log.txt';
        ...
        is_null(self::$driver) && self::init($log);
