...
$configs= array(
		...
		'MYINFOUPLOADPATH'		=> 'data/myInfoUpload/',
		...
		'APP_GROUP_LIST'        => 'Admin,Api',      // 项目分组设定,多个组之间用逗号分隔,例如'Home,Admin'
		...
		'SP_TMPL_PATH'     		=> 'tmp/',       // 前台模板文件根目录
		'SP_DEFAULT_THEME'		=> '',       // 前台模板文件
		'SP_TMPL_ACTION_ERROR' 	=> '', // 默认错误跳转对应的模板文件,注：相对于前台模板路径
		'SP_TMPL_ACTION_SUCCESS' 	=> 'success', // 默认成功跳转对应的模板文件,注：相对于前台模板路径
		'SP_ADMIN_STYLE'		=> 'flat',
		'SP_ADMIN_TMPL_PATH'    => 'tmp/',       // 各个项目后台模板文件根目录
		'SP_ADMIN_TMPL_ACTION_ERROR' 	=> 'Admin/error.html', // 默认错误跳转对应的模板文件,注：相对于后台模板路径
		'SP_SHOP_TMPL_ACTION_ERROR' 	=> 'Shop/error.html',//默认错误跳转对应的模板文件,注：相对于后台Shop模块模板路径
		'SP_Member_TMPL_ACTION_ERROR' 	=> 'Shop/error.html',//默认错误跳转对应的模板文件,注：相对于后台Member模块模板路径
		'SP_ADMIN_TMPL_ACTION_SUCCESS' 	=> 'Admin/success.html', // 默认成功跳转对应的模板文件,注：相对于后台模板路径
		'SP_SHOP_TMPL_ACTION_SUCCESS' 	=> 'Shop/success.html',//默认成功跳转对应的模板文件,注：相对于后台Shop模块模板路径
		'SP_Member_TMPL_ACTION_SUCCESS' 	=> 'Shop/success.html',//默认成功跳转对应的模板文件,注：相对于后台Member模块模板路径
		// 'TMPL_EXCEPTION_FILE'   => SPSTATIC.'exception1/.html',
