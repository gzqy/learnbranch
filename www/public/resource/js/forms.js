...
function bindStatistics(){
    ...
    $("._change_day").click(function(){
        ...
        $("input[name=type]").val(start_date);
        $(this).css('background','red');
        $(this).siblings('button').css('background','#09c');
    });
}
...
function downloadFiles(){
    ...
    $('#_exp_form').attr('action','/index/DownloadLogs');
    $('#_exp_form').submit();
